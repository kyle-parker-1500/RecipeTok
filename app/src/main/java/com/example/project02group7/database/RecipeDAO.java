...
public interface RecipeDAO {
    ...
    @Query("SELECT recipeTable.id, recipeTable.title, recipeTable.instructions, recipeTable.ingredients FROM recipeTable INNER JOIN userSavedRecipesTable on userSavedRecipesTable.RecipeId == recipeTable.id WHERE userSavedRecipesTable.userId == :userId")
